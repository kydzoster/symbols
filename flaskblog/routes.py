...
# reset password request to email in text format
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Reset password instructions has been sent to your email!' 'info')
        return redirect(url_for('login'))
    return render_template('reset_request.html', title='Reset Password', form=form)

# will actually reset their password with the token active
